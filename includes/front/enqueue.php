...
function ju_enqueue(){
    ...
    wp_register_style( 'ju_font_icons', $uri . '/assets/css/font_icons.css', [], $ver );
    wp_register_style( 'ju_animate', $uri . '/assets/css/animate.css', [], $ver );
    wp_register_style( 'ju_magnific_popup', $uri . '/assets/css/magnific_popup.css', [], $ver );
    ...
    wp_enqueue_style( 'ju_google.fonts' );
